INSERT INTO aula (aula_titulo, aula_descricao, aula_nivel) VALUES
('IA: O que é e para que serve?', 'Introdução simples sobre como a inteligência artificial funciona no celular e na TV.', 'Iniciante'),
('ChatGPT para o dia a dia', 'Como conversar com a IA para tirar dúvidas, pedir receitas ou sugestões de viagens.', 'Iniciante'),
